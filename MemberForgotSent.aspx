<%@ Page Title="" Language="C#" MasterPageFile="~/DoMaster.master" AutoEventWireup="true" CodeFile="MemberForgotSent.aspx.cs" Inherits="MemberForgotSent" %>
...
<div id="user_forgot_form" style="padding-left:250px;padding-top:80px;">
	...
	<span style="color: #1c94c4;">密碼已送出</span>
	</div>
	<div style="border: 2px dotted #cccccc;width:300px;padding:20px;">

	<span style="color:#666666;font-size:10px;">密碼已送出, 請至您的Email收取。</span>
