<%@ Page Title="" Language="C#" MasterPageFile="~/DoMaster.master" AutoEventWireup="true" CodeFile="MemberRegister.aspx.cs" Inherits="MemberRegister" EnableSessionState="True" %>
...
<div id="user_register_form">
    ...
    <table summary="user register" >
        ...
        <tr>
            <td align="right" valign="bottom"><label>驗證碼</label></td>
            <td>
                <img id="captcha" src="BuildCaptcha.aspx" />
                <span style="padding-left:10px;"></span>
                <input type="button" value="變更圖片" onclick="captcha.src='BuildCaptcha.aspx?r=' + (new Date()).getTime()" style="border:1px solid #666666; padding:2px;"/>
                <br/>
                <input type="text" name="verify" size="10" /> (請輸入驗證碼)
